...
namespace Exercicios.Tests
{
    ...
    public class HelloWorldTest
    {
        ...
        public void Declarar_Sem_Inicializar_Test()
        {
            ...
            // Não podemos inicializar variaveis implicitas sem atribuir valor
            //var nome;
            //nome = "Leia";
            //Assert.AreEqual(typeof(string), nome.GetType());
        }
        ...
        {
            var array = new string [] {"Léia", "Tequila", "Yuri"}; 
        ...
        {
            var array = new[] { "Léia", "Tequila", "Yuri" };
        ...
        {
            var lista = new List<string> { "Léia", "Tequila", "Yuri" };
            lista.Add("Xyz");
            lista.Remove("Yuri");
